...
- **Visualisasi (Histogram/Boxplot):**
  - *Sematkan gambar plot dari folder /results...*
     jawaban : result/boxplot_Pendapatan_Tahunan_Miliar_IDR.png , result/histogram_Pendapatan_Tahunan_Miliar_IDR.png
...
- **Plot Q-Q:**
  - *Sematkan gambar plot dari folder /results...*
    jawaban : ![alt text](<img width="2400" height="1800" alt="Image" src="https://github.com/user-attachments/assets/6e74b31c-a620-499d-9c17-839e3742becf" />)
...
- **Visualisasi (Scatter Plot):**
  - *Sematkan gambar plot dari folder /results...*
    jawaban : result/scatterplot_Pendapatan_Tahunan_Miliar_IDR_vs_Biaya_Akuisisi_Pelanggan_Juta_IDR.png
...
- **Visualisasi (Garis Regresi pada Scatter Plot):**
  - *Sematkan gambar plot dari folder /results...*
    jawaban : result/plot_regresi_Pendapatan_Tahunan_Miliar_IDR_vs_Biaya_Akuisisi_Pelanggan_Juta_IDR.png
